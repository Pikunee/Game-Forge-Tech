              ...
              <div class="col-lg-12">
                <div class="featured-games header-text">
                  ...
                  <div class="owl-features owl-carousel">
                    <div class="item">
                      <div class="thumb">
                      <a href="genshin_impact.php"><img src="assets/images/genshin_impact_fg.jpeg" alt="" /></a>
                        <div class="hover-effect">
                          <h6>2.4K Streaming</h6>
                        </div>
                      </div>
                      <h4>Genshin Impact<br /><span>249K Downloads</span></h4>
                      <ul>
                    ...
                    <div class="item">
                      <div class="thumb">
                      <a href="pubg_mobile.php"><img src="assets/images/pubg_mobile_fg.jpeg" alt="" /></a>
                        <div class="hover-effect">
                          <h6>2.4K Streaming</h6>
                        </div>
                      </div>
                      <h4>PUBG MOBILE<br /><span>249K Downloads</span></h4>
                      <ul>
                        <li><i class="fa fa-star"></i> 4.8</li>
                        <li><i class="fa fa-download"></i> 2.3M</li>
                      </ul>
                    ...
                    <div class="item">
                      <div class="thumb">
                      <a href="dota_2.php"><img src="assets/images/dota_2_fg.jpeg" alt="" /></a>
                        <div class="hover-effect">
                          <h6>2.4K Streaming</h6>
                        </div>
                      </div>
                      <h4>DOTA 2<br /><span>249K Downloads</span></h4>
                      <ul>
                        <li><i class="fa fa-star"></i> 4.8</li>
                        <li><i class="fa fa-download"></i> 2.3M</li>
                      </ul>
                    ...
                    <div class="item">
                      <div class="thumb">
                      <a href="mobile_lagend.php"><img src="assets/images/mobile_lagend_fg.jpeg" alt="" /></a>
                        <div class="hover-effect">
                          <h6>2.4K Streaming</h6>
                        </div>
                      </div>
                      <h4>MOBILE LAGEND<br /><span>249K Downloads</span></h4>
                      <ul>
                        <li><i class="fa fa-star"></i> 4.8</li>
                        <li><i class="fa fa-download"></i> 2.3M</li>
                      </ul>
                    ...
                    <div class="item">
                      <div class="thumb">
                      <a href="honkai_star_rail.php"><img src="assets/images/honkai_star_rail_fg.jpeg" alt="" /></a>
                        <div class="hover-effect">
                          <h6>2.4K Streaming</h6>
                        </div>
                      </div>
                      <h4>HONKAI STAR RAIL<br /><span>249K Downloads</span></h4>
                      <ul>
                        <li><i class="fa fa-star"></i> 4.8</li>
                        <li><i class="fa fa-download"></i> 2.3M</li>
                      </ul>
                    ...
                    <div class="item">
                      <div class="thumb">
                      <a href="lol_wild_rift.php"><img src="assets/images/lol_wild_rift_fg.jpeg" alt="" /></a>
                        <div class="hover-effect">
                          <h6>2.4K Streaming</h6>
                        </div>
                      </div>
                      <h4>Lol Wild Rift<br /><span>249K Downloads</span></h4>
                      <ul>
                        <li><i class="fa fa-star"></i> 4.8</li>
                        <li><i class="fa fa-download"></i> 2.3M</li>
                      </ul>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <p>
              Copyright © 2036 <a href="#">GameForgeTech</a> Company. All rights
              reserved.
