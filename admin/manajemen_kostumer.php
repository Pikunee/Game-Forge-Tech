    ...
    <div class="container my-5">
      <div class="card">
        <div class="card-header">
          <h4 class="text-center">DAFTAR KOSTUMER</h4>
        </div>
        <div class="card-body">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              include("koneksi.php");
              $no = 1;
              $query = mysqli_query($connection, "SELECT * FROM kostumer");
              ...
              <tr>
                ...
                <td>
                  <a href="update_data.php?id=<?php echo $row['id']?>" class='btn btn-warning'>Update</a>
                  <a href="hapus_data.php?id=<?php echo $row['id']?>" class='btn btn-danger'>Delete</a>
                </td>
              </tr>
              <?php 
              }
